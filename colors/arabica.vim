" Name:         evening arabica
" Description:  This a color scheme based on evening.
" Author:       Original author Bram Moolenaar <Bram@vim.org>
" Maintainer:   KrispyEnsign
...
hi Normal guifg=#ffffff guibg=#231a00 gui=NONE cterm=NONE
hi EndOfBuffer guifg=#add8e6 guibg=#231a00 gui=NONE cterm=NONE
hi TabLine guifg=#231a00 guibg=#d3d3d3 gui=NONE cterm=NONE
hi TabLineSel guifg=#231a00 guibg=#ffffff gui=bold cterm=bold
hi StatusLine guifg=#231a00 guibg=#ffffff gui=bold cterm=bold
...
hi StatusLineNC guifg=#d3d3d3 guibg=#231a00 gui=NONE cterm=NONE
...
hi Folded guifg=#666666 guibg=#231a00 gui=bold cterm=bold
...
hi NonText guifg=#add8e6 guibg=#231a00 gui=NONE cterm=NONE
...
hi Ignore guifg=#231a00 guibg=NONE gui=NONE cterm=NONE
...
hi StorageClass guifg=#ffa500 guibg=NONE gui=italic cterm=italic
hi Structure guifg=#ffff60 guibg=NONE gui=bold cterm=bold
hi Underlined guifg=#80a0ff guibg=NONE gui=underline cterm=underline
hi Function guifg=#ff80ff guibg=NONE gui=italic cterm=italic
...
if s:t_Co >= 256
  ...
  hi EndOfBuffer ctermfg=153 ctermbg=16 cterm=NONE
  ...
  hi CursorLineNr ctermfg=226 ctermbg=236 cterm=NONE
  ...
  hi Folded ctermfg=241 ctermbg=16 cterm=bold
  ...
  hi NonText ctermfg=153 ctermbg=16 cterm=NONE
  ...
  hi String ctermfg=46 ctermbg=NONE cterm=NONE
  ...
  hi StorageClass ctermfg=214 ctermbg=NONE cterm=italic
  hi Structure ctermfg=227 ctermbg=NONE cterm=bold
  hi Underlined ctermfg=111 ctermbg=NONE cterm=underline
  hi Function ctermfg=201 ctermbg=NONE cterm=italic
...
if s:t_Co >= 16
  ...
  hi EndOfBuffer ctermfg=lightblue ctermbg=black cterm=NONE
  ...
  hi NonText ctermfg=lightblue ctermbg=black cterm=NONE
  ...
  hi StorageClass ctermfg=darkred ctermbg=NONE cterm=italic
  hi Structure ctermfg=yellow ctermbg=NONE cterm=bold
  hi Underlined ctermfg=lightblue ctermbg=NONE cterm=underline
  hi Function ctermfg=darkmagenta ctermbg=NONE cterm=italic
...
if s:t_Co >= 8
  ...
  hi StorageClass ctermfg=darkred ctermbg=NONE cterm=italic
  hi Structure ctermfg=darkyellow ctermbg=NONE cterm=bold
...
" Color: grey20        #333333           236               darkgray
...
" Color: espresso      #231a00           16                black
