...
hi Function guifg=#00ff00 guibg=NONE gui=italic cterm=italic
...
if s:t_Co >= 256
  ...
  hi Function ctermfg=46 ctermbg=NONE cterm=italic
...
if s:t_Co >= 16
  ...
  hi Function ctermfg=green ctermbg=NONE cterm=italic
...
if s:t_Co >= 8
  ...
  hi Function ctermfg=darkgreen ctermbg=NONE cterm=italic
  hi DiffAdd ctermfg=white ctermbg=darkgreen cterm=NONE
